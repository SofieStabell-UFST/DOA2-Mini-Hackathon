...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26779 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26779(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26780 = (function (port,val,fn1_handler){
var x__4509__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26780(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26784 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26784(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26787 = (function (chan){
var x__4509__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26787(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26790 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26790(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26793 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26793(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26797 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26797(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26802 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26802(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26803 = (function (b,itm){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26803(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26805 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26805(b);
}
});
