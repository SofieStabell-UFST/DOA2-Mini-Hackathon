...
return (function() { 
var G__36771__delegate = function (args){
...
return G__36771__delegate.call(this,args);};
...
return G__36771__delegate(args);
});
...
var G__36678 = o;
goog.object.set(G__36678,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__36684 = props;
var G__36684__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36684,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__36684);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36684__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4212__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__36687 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36687,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__36687;
}
})(),id_class);
...
var G__36689 = (cljs.core.count(argv) - first_child);
switch (G__36689) {
case (0):
...
var vec__36693 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36693,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36693,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36693,(2),null);
...
var temp__5757__auto___36810 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___36810 == null)){
} else {
var key_36811 = temp__5757__auto___36810;
(jsprops.key = key_36811);
}
...
var temp__5757__auto___36813 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___36813 == null)){
} else {
var key_36814 = temp__5757__auto___36813;
(jsprops.key = key_36814);
}
...
var temp__5757__auto___36815 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___36815 == null)){
} else {
var key_36818 = temp__5757__auto___36815;
(jsprops.key = key_36818);
}
...
var temp__5757__auto___36836 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___36836 == null)){
} else {
var key_36840 = temp__5757__auto___36836;
...
var temp__5757__auto___36842 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___36842 == null)){
} else {
var key_36843 = temp__5757__auto___36842;
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36727_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__36727_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__36734 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36734,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36734,(1),null);
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template36759 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template36759 = (function (opts,id,fn_to_element,meta36760){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template36759.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_36761,meta36760__$1){
var self__ = this;
var _36761__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template36759(self__.opts,self__.id,self__.fn_to_element,meta36760__$1));
}));

(reagent.impl.template.t_reagent$impl$template36759.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_36761){
var self__ = this;
var _36761__$1 = this;
return self__.meta36760;
}));

(reagent.impl.template.t_reagent$impl$template36759.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template36759.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template36759.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template36759.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template36759.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta36760","meta36760",-508205318,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template36759.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template36759.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template36759");

(reagent.impl.template.t_reagent$impl$template36759.cljs$lang$ctorPrWriter = (function (this__4450__auto__,writer__4451__auto__,opt__4452__auto__){
return cljs.core._write(writer__4451__auto__,"reagent.impl.template/t_reagent$impl$template36759");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template36759.
 */
reagent.impl.template.__GT_t_reagent$impl$template36759 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template36759(opts__$1,id__$1,fn_to_element__$1,meta36760){
return (new reagent.impl.template.t_reagent$impl$template36759(opts__$1,id__$1,fn_to_element__$1,meta36760));
});

}

return (new reagent.impl.template.t_reagent$impl$template36759(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
