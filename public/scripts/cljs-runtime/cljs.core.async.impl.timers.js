...
var i_29501 = (0);
while(true){
if((i_29501 < arr.length)){
(arr[i_29501] = null);

var G__29506 = (i_29501 + (1));
i_29501 = G__29506;
continue;
} else {
}
...
var i_29530 = (self__.level + (1));
while(true){
if((i_29530 <= (new_level + (1)))){
(update[i_29530] = self__.header);

var G__29535 = (i_29530 + (1));
i_29530 = G__29535;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_29536 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_29536[i]));
} else {
x__$2.forward.push((((i < links_29536.length))?(links_29536[i]):null));
}

if((i < links_29536.length)){
(links_29536[i] = x__$2);
} else {
links_29536.push(x__$2);
}
...
var i_29546 = (0);
while(true){
if((i_29546 <= self__.level)){
var links_29548 = (update[i_29546]).forward;
if((x__$1 === (((i_29546 < links_29548.length))?(links_29548[i_29546]):null))){
(links_29548[i_29546] = (x__$1.forward[i_29546]));

var G__29549 = (i_29546 + (1));
i_29546 = G__29549;
continue;
} else {
var G__29550 = (i_29546 + (1));
i_29546 = G__29550;
continue;
}
} else {
...
var G__29560 = nx;
var G__29561 = (level__$1 - (1));
x = G__29560;
level__$1 = G__29561;
continue;
} else {
var G__29562 = x;
var G__29563 = (level__$1 - (1));
x = G__29562;
level__$1 = G__29563;
continue;
}
