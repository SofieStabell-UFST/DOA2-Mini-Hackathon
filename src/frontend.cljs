...
(defn mini-app []
      [:div.container
       [:div
        ...
        [:div.process-time.process-time-1 "Process time"] [:div [:input.input-process-time.input-process-time-1 {:type "text" :placeholder @ps1-input :maxlength "4" :size "1"}][:div.label-ps.label-ps-1 "sek"]]
        [:div.process-time.process-time-2 "Process time"] [:div [:input.input-process-time.input-process-time-2 {:type "text" :placeholder @ps2-input :maxlength "4" :size "1"}][:div.label-ps.label-ps-2 "sek"]]
        [:div.process-time.process-time-3 "Process time"] [:div [:input.input-process-time.input-process-time-3 {:type "text" :placeholder @ps3-input :maxlength "4" :size "1"}][:div.label-ps.label-ps-3 "sek"]]
        [:div.process-time.process-time-4 "Process time"] [:div [:input.input-process-time.input-process-time-4 {:type "text" :placeholder @ps4-input :maxlength "4" :size "1"}][:div.label-ps.label-ps-4 "sek"]]
        [:div.process-time.process-time-5 "Process time"] [:div [:input.input-process-time.input-process-time-5 {:type "text" :placeholder @ps5-input :maxlength "4" :size "1"}][:div.label-ps.label-ps-5 "sek"]]
